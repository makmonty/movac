 ...
 */
	public static function reset() {
		if (empty(self::$_initialState)) {
			self::$_initialState = get_class_vars('\inflection\Inflector');
			return;
		}
...
\inflection\Inflector::reset();



//reglas en español

\inflection\Inflector::rules('singular', array(
		'rules' => array(
...
\inflection\Inflector::rules('plural', array(
		'rules' => array(
